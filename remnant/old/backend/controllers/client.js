...
const editClient = async ({
  ...
  const editedClient = await clientModel.updateOne(
    { _id },
    { name, middlename, lastname, emails, phones, dayofbirth, comment, orders }
  );
...
const getClients = async ({ filter, sorter, pagination }) => {
  ...
  let clientsQuery = clientModel.aggregate(pipeline);
