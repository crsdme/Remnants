...
import { Filter, Plus, X, Check, XCircle } from 'lucide-react';
...
type FormItem = z.infer<typeof filterItemSchema>;

export const AdvancedFilters = ({ columns, onSubmit, onCancel }: AdvancedFiltersProps) => {
  ...
  const renderInput = (item: FormItem, index: number) => {
