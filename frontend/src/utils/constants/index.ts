...
export const NAV_MENU_ITEMS = [
  ...
  },
  {
    id: 'money',
    icon: 'Banknote',
    permissions: ['money.page', 'cashregister.page', 'cashregisterAccount.page', 'expense.page', 'investor.page', 'supplier.page', 'moneyTransaction.page'],
    items: [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'auditLogs', url: '/settings/audit-logs', permissions: ['auditLog.page'] },
...
export const USER_ROLE_PERMISSIONS = [
  ...
  {
    group: 'procurement',
    dependencies: ['language.read', 'supplier.read', 'warehouse.read', 'expense.read'],
    permissions: ['procurement.page', 'procurement.read', 'procurement.remove', 'procurement.create', 'procurement.edit', 'procurement.export', 'procurement.auditLogs'],
  },
  {
