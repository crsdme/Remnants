...
import {
  ...
  useRequestProductPropertiesGroups,
  useRequestUnits,
} from '@/api/hooks/'
...
export function ProductProvider({ children }: ProductProviderProps) {
  ...
  //     categories: z.array(z.string({ required_error: t('form.errors.required') })).min(1, { message: t('form.errors.required') }),
  ...
  // const defaultPropertiesValues = useMemo(() => getDefaultPropertiesValues(selectedGroup, productPropertiesGroups), [selectedGroup, productPropertiesGroups])
  ...
  const getProductFormValues = (product) => {
    if (product) {
      ...
      return {
        ...
        categories: [],
        productProperties: getPropertiesDefaultValues(selectedGroup, productPropertiesGroups),
