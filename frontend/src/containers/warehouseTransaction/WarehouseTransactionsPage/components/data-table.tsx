...
export function DataTable() {
  ...
  const { warehouseTransactions, warehouseTransactionsCount, isLoading, isFetching } = useWarehouseTransactionQuery(
    ...
    <>
      <div className="w-full flex justify-between items-start max-md:flex-col gap-2 py-2">
        ...
        <div className="flex gap-2">
          <ColumnVisibilityMenu table={table} tableId="warehouse-transaction" />
        </div>
      </div>
...
//   const { warehouseTransactionItems, isLoading, isFetching, error } = useWarehouseTransactionItemsQuery(
...
//           {warehouseTransactionItems.map(item => (
//             <Badge key={item.id}>
