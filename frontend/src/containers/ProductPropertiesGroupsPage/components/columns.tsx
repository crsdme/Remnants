...
const columnHelper = createColumnHelper<ProductPropertyGroupPopulatedDTO>()
...
export function useColumns() {
  ...
  const columns = useMemo(() => {
    function sortHeader(column: Column<ProductPropertyGroupPopulatedDTO>, label: string) {
    ...
    return [
      columnHelper.accessor(row => row.names?.[language] || row.names?.en, {
        ...
        size: 150,
        meta: {
          title: t('page.product-properties-groups.table.names'),
          batchEdit: true,
        ...
        header: ({ column }) => sortHeader(column, t('page.product-properties-groups.table.names')),
      }),
      columnHelper.accessor('priority', {
        id: 'priority',
        meta: {
          title: t('page.product-properties-groups.table.priority'),
          batchEdit: true,
        ...
        header: ({ column }) => sortHeader(column, t('page.product-properties-groups.table.priority')),
        cell: ({ row }) => <Badge variant="outline">{row.original.priority}</Badge>,
      }),
      columnHelper.accessor('active', {
        id: 'active',
        meta: {
          title: t('page.product-properties-groups.table.active'),
          batchEdit: true,
  ...
  }, [language, isLoading, openModal, removeGroup, t])
  return columns
}
