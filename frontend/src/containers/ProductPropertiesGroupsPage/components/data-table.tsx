...
export function DataTable() {
  ...
  const { productPropertyGroups = [], productPropertyGroupsCount = 0, isLoading, isFetching } = useProductPropertyGroupQuery(
  ...
  const renderRow = (row: Row<ProductPropertyGroupPopulatedDTO>) => (
    <Fragment key={row.id}>
      <TableRow
