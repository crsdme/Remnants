...
type CreateInventoryProductRow = ProductPopulatedDTO & {
  lineQuantity?: number
...
const columnHelper = createColumnHelper<CreateInventoryProductRow>()
...
export function useColumns(
  ...
  const columns = useMemo(() => {
    function sortHeader(column: Column<CreateInventoryProductRow, unknown>, label: string) {
