...
export async function get(payload: GetUnitsParams): Promise<GetUnitsResponse> {
...
export async function create(payload: CreateUnitsParams): Promise<CreateUnitsResponse> {
...
export async function edit(payload: EditUnitsParams): Promise<EditUnitsResponse> {
  const { id } = payload
...
export async function remove(payload: RemoveUnitsParams): Promise<RemoveUnitsResponse> {
  const { ids } = payload
...
// export async function batch(payload: batchUnitsParams): Promise<batchUnitsResult> {
...
// export async function importHandler(payload: importUnitsParams): Promise<importUnitsResult> {
//   const { file } = payload
...
// export async function duplicate(payload: duplicateUnitParams): Promise<duplicateUnitResult> {
//   const { ids } = payload
